 ...
 *
 * $Id: main.c 15287 2014-09-23 16:27:33Z kevin.gillespie $
 *
 *******************************************************************************
 */
...
int32_t ow_romid_test(uint8_t od)
{
    ...
    if(OWM_Read(buffer, 8) < 0) return -5;
...
int main(void)
{
    ...
    owm_cfg_t owm_cfg;
    owm_cfg.int_pu_en = 1;
    owm_cfg.ext_pu_mode = OWM_EXT_PU_ACT_HIGH;
    owm_cfg.long_line_mode = 0;
    // owm_cfg.overdrive_spec =OWM_OVERDRIVE_10US;
    OWM_Init(&owm_cfg, NULL);
