...
C_FILES += \
    $(ROOT_DIR)/ble-profiles/sources/apps/tag/tag_main_wdxs.c \
    $(sort $(wildcard $(ROOT_DIR)/ble-profiles/sources/apps/wdxs/*.c))
else
C_FILES += \
    $(ROOT_DIR)/ble-profiles/sources/apps/tag/tag_main.c
endif
