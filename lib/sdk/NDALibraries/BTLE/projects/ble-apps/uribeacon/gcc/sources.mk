...
C_FILES += \
	...
	$(ROOT_DIR)/ble-profiles/sources/apps/uribeacon/uribeacon_main.c \
	$(ROOT_DIR)/projects/ble-apps/uribeacon/main.c \
	$(ROOT_DIR)/projects/ble-apps/uribeacon/stack_uribeacon.c
