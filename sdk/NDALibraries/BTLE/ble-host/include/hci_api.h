 ...
 * NOTE: The length and order of this list must match the events in dm_main.c
 * NOTE: The first event, RESET_SEQ, is set to zero to match the original #define event list.
 */
/**@{*/
enum
{
  HCI_RESET_SEQ_CMPL_CBACK_EVT = 0,                 /*!< \brief Reset sequence complete */
  HCI_LE_CONN_CMPL_CBACK_EVT,                       /*!< \brief LE connection complete */
  HCI_LE_ENHANCED_CONN_CMPL_CBACK_EVT,              /*!< \brief LE enhanced connection complete */
  HCI_DISCONNECT_CMPL_CBACK_EVT,                    /*!< \brief LE disconnect complete */
  HCI_LE_CONN_UPDATE_CMPL_CBACK_EVT,                /*!< \brief LE connection update complete */
  HCI_LE_CREATE_CONN_CANCEL_CMD_CMPL_CBACK_EVT,     /*!< \brief LE create connection cancel command complete */
  HCI_LE_ADV_REPORT_CBACK_EVT,                      /*!< \brief LE advertising report */
  HCI_READ_RSSI_CMD_CMPL_CBACK_EVT,                 /*!< \brief Read RSSI command complete */
  HCI_LE_READ_CHAN_MAP_CMD_CMPL_CBACK_EVT,          /*!< \brief LE Read channel map command complete */
  HCI_READ_TX_PWR_LVL_CMD_CMPL_CBACK_EVT,           /*!< \brief Read transmit power level command complete */
  HCI_READ_REMOTE_VER_INFO_CMPL_CBACK_EVT,          /*!< \brief Read remote version information complete */
  HCI_LE_READ_REMOTE_FEAT_CMPL_CBACK_EVT,           /*!< \brief LE read remote features complete */
  HCI_LE_LTK_REQ_REPL_CMD_CMPL_CBACK_EVT,           /*!< \brief LE LTK request reply command complete */
  HCI_LE_LTK_REQ_NEG_REPL_CMD_CMPL_CBACK_EVT,       /*!< \brief LE LTK request negative reply command complete */
  HCI_ENC_KEY_REFRESH_CMPL_CBACK_EVT,               /*!< \brief Encryption key refresh complete */
  HCI_ENC_CHANGE_CBACK_EVT,                         /*!< \brief Encryption change */
  HCI_LE_LTK_REQ_CBACK_EVT,                         /*!< \brief LE LTK request */
  HCI_VENDOR_SPEC_CMD_STATUS_CBACK_EVT,             /*!< \brief Vendor specific command status */
  HCI_VENDOR_SPEC_CMD_CMPL_CBACK_EVT,               /*!< \brief Vendor specific command complete */
  HCI_VENDOR_SPEC_CBACK_EVT,                        /*!< \brief Vendor specific */
  HCI_HW_ERROR_CBACK_EVT,                           /*!< \brief Hardware error */
  HCI_LE_ADD_DEV_TO_RES_LIST_CMD_CMPL_CBACK_EVT,    /*!< \brief LE add device to resolving list command complete */
  HCI_LE_REM_DEV_FROM_RES_LIST_CMD_CMPL_CBACK_EVT,  /*!< \brief LE remove device from resolving command complete */
  HCI_LE_CLEAR_RES_LIST_CMD_CMPL_CBACK_EVT,         /*!< \brief LE clear resolving list command complete */
  HCI_LE_READ_PEER_RES_ADDR_CMD_CMPL_CBACK_EVT,     /*!< \brief LE read peer resolving address command complete */
  HCI_LE_READ_LOCAL_RES_ADDR_CMD_CMPL_CBACK_EVT,    /*!< \brief LE read local resolving address command complete */
  HCI_LE_SET_ADDR_RES_ENABLE_CMD_CMPL_CBACK_EVT,    /*!< \brief LE set address resolving enable command complete */
  HCI_LE_ENCRYPT_CMD_CMPL_CBACK_EVT,                /*!< \brief LE encrypt command complete */
  HCI_LE_RAND_CMD_CMPL_CBACK_EVT,                   /*!< \brief LE rand command complete */
  HCI_LE_REM_CONN_PARAM_REP_CMD_CMPL_CBACK_EVT,     /*!< \brief LE remote connection parameter request reply complete */
  HCI_LE_REM_CONN_PARAM_NEG_REP_CMD_CMPL_CBACK_EVT, /*!< \brief LE remote connection parameter request negative reply complete */
  HCI_LE_READ_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT,      /*!< \brief LE read suggested default data length command complete */
  HCI_LE_WRITE_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT,     /*!< \brief LE write suggested default data length command complete */
  HCI_LE_SET_DATA_LEN_CMD_CMPL_CBACK_EVT,           /*!< \brief LE set data length command complete */
  HCI_LE_READ_MAX_DATA_LEN_CMD_CMPL_CBACK_EVT,      /*!< \brief LE read maximum data length command complete */
  HCI_LE_REM_CONN_PARAM_REQ_CBACK_EVT,              /*!< \brief LE remote connection parameter request */
  HCI_LE_DATA_LEN_CHANGE_CBACK_EVT,                 /*!< \brief LE data length change */
  HCI_LE_READ_LOCAL_P256_PUB_KEY_CMPL_CBACK_EVT,    /*!< \brief LE read local P-256 public key */
  HCI_LE_GENERATE_DHKEY_CMPL_CBACK_EVT,             /*!< \brief LE generate DHKey complete */
  HCI_WRITE_AUTH_PAYLOAD_TO_CMD_CMPL_CBACK_EVT,     /*!< \brief Write authenticated payload timeout command complete */
  HCI_AUTH_PAYLOAD_TO_EXPIRED_CBACK_EVT,            /*!< \brief Authenticated payload timeout expired event */
  HCI_LE_READ_PHY_CMD_CMPL_CBACK_EVT,               /*!< \brief LE read phy command complete */
  HCI_LE_SET_DEF_PHY_CMD_CMPL_CBACK_EVT,            /*!< \brief LE set default phy command complete */
  HCI_LE_PHY_UPDATE_CMPL_CBACK_EVT,                 /*!< \brief LE phy update complete */
  HCI_LE_EXT_ADV_REPORT_CBACK_EVT,                  /*!< \brief LE extended advertising report */
  HCI_LE_SCAN_TIMEOUT_CBACK_EVT,                    /*!< \brief LE scan timeout event */
  HCI_LE_ADV_SET_TERM_CBACK_EVT,                    /*!< \brief LE advertising set terminated event */
  HCI_LE_SCAN_REQ_RCVD_CBACK_EVT,                   /*!< \brief LE scan request received event */
  HCI_LE_PER_ADV_SYNC_EST_CBACK_EVT,                /*!< \brief LE periodic advertising sync established event */
  HCI_LE_PER_ADV_REPORT_CBACK_EVT,                  /*!< \brief LE periodic advertising report event */
  HCI_LE_PER_ADV_SYNC_LOST_CBACK_EVT,               /*!< \brief LE periodic advertising synch lost event */
  HCI_LE_CH_SEL_ALGO_CBACK_EVT,                     /*!< \brief LE channel selection algorithm event */
  HCI_LE_SCAN_ENABLE_CMPL_CBACK_EVT,                /*!< \brief LE scan enable complete event */
  HCI_LE_ADV_ENABLE_CMPL_CBACK_EVT,                 /*!< \brief LE advertise enable complete event */
  HCI_LE_EXT_SCAN_ENABLE_CMPL_CBACK_EVT,            /*!< \brief LE extended scan enable complete event */
  HCI_LE_EXT_ADV_ENABLE_CMPL_CBACK_EVT,             /*!< \brief LE extended advertise enable complete event */
  HCI_LE_PER_ADV_ENABLE_CMPL_CBACK_EVT,             /*!< \brief LE periodic advertise enable complete event */
  HCI_READ_LOCAL_VER_INFO_CMPL_CBACK_EVT,           /*!< \brief Read local version info complete event */
  HCI_EVENT_COUNT
};
/**@}*/
 ...
 *  \fn     HciVsSetFeatures
 *
 *  \brief  Set link layer features to be reported by link layer.
 *
 *  \param  features Byte array containing features
 *  to be reported as being supported by the link layer.
 *  \param  featuresMask Pointer to new feature mask set buffer.
...
/*************************************************************************************************/
/*!
 *  \brief  Return the default data length.
 *
 *  \return default data length.
 */
/*************************************************************************************************/
...
/*************************************************************************************************/
/*!
 *  \brief  Return the maximum data length.
 *
